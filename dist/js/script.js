...
var slides = new Array(
  "https://source.unsplash.com/random/480x424",
  "https://source.unsplash.com/random/480x423",
  "https://source.unsplash.com/random/480x422",
  "https://source.unsplash.com/random/480x421",
  "https://source.unsplash.com/random/480x420"
);
...
function transition(id) {
  ...
  var newLayer = $('<div class="mosaic-slide">').html(
    generateGrid({ rows: 7, cols: 8, image: slides[id - 1] })
  );
